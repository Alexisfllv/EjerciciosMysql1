-- Procedimientos almacenados (definición de variables locales) 103
...
-- 
drop procedure if exists pa_cantidad_clientes_pronvicias;

delimiter //
create procedure pa_cantidad_clientes_pronvicias
(
...
call pa_cantidad_clientes_pronvicias('Cordoba ', 'Santa Fe');
